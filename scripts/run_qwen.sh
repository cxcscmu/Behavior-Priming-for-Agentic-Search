...
echo "Running on hle"
python3 main_parallel.py --batch_file evaluation/short/hle/test.json \
...
python3 main_parallel.py --batch_file evaluation/short/gaia/test.json \
